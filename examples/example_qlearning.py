...
q_function, pi = qlearning(model, alpha=0.9, epsilon=0.2, maxiter=100, maxeps=100000)

# plot the results
path = "../doc/imgs/qlearning_cliffworld.png"
plot_gridworld(model, value_function=q_function, policy=pi, title="Q-Learning", path=path)