...
#
#
# assert np.any(model.R == small_world['R'][0][0][:,0])
# assert model.P[:,:,0] == small_world['P'][0][0][:,:,0]
# assert model.P[:,:,1] == small_world['P'][0][0][:,:,1]
# assert model.P[:,:,2] == small_world['P'][0][0][:,:,2]
# assert model.P[:,:,3] == small_world['P'][0][0][:,:,3]
#
#
# # plt.figure()
# # plt.imshow(model.P[:,:,0]);
# # plt.colorbar()
# # plt.show()